//This script include works with Business rule: Generate Template On Approval
var StdChangeUtilsDIW = Class.create();
StdChangeUtilsDIW.prototype = Object.extendsObject(AbstractAjaxProcessor, {
	...
	initialize: function(request, responseXML, gc) {
		AbstractAjaxProcessor.prototype.initialize.call(this, request,
			responseXML,
			gc);
		this.log = new GSLog('com.snc.std_change_request.log', 'StdChangeUtilsDIW');
